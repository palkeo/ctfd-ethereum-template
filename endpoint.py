...
MIN_DUMMY_CONTRACTS = 10
MAX_DUMMY_CONTRACTS = 30
...
def create_contract():
    logger.info("Creating new contract... Last block is %i", w3.eth.blockNumber)
    ...
    logger.info("From address: %s", from_addr)
...
def contract_creator():
    while True:
        ...
        for i in range(random.randint(MIN_DUMMY_CONTRACTS, MAX_DUMMY_CONTRACTS)):
            create_contract()
